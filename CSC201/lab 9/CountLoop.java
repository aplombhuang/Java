 ...
 *the next interger to add is calculated by starting with 1 and increments as the loop repeat
 *mean time the loop is to add the integer 1 by 1 until the number of time 
 *this loop runs equals the number user entered
 * 
 *return sum
 */
 ...
 private static void printHeading()
    ...
    public static void main(String[] args) 
    {
        ...
        do{
            ...
            System.out.println("Please enter a whole number between 1 to 100. \n The program will calculate the sum from 1 to the number you entered. \n Please be sure the number you enter is an integer.");
            ...
            if(timeIn.hasNextInt()) //This statement checks if the user input is an integer or not
            {
                times = timeIn.nextInt(); System.out.println(""); 
                 ...
                 else if(times > 100){System.out.println("Error!! Please enter a positive integer between 1 and 100.\n"); times = 0;}
                 
                 else{ loop1 = loop1 + 1; System.out.println("The program will calculate the sum of all the integers from 1 to " +  times ); } 
              
            }else
            {                   
                System.out.println("Error!! Please enter an integer number, not any other things.\n"  );

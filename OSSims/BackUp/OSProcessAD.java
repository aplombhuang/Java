...
public class OSProcessAD{
	...
	private int mem, memOfPro, cpuPro1, cpuPro2, cpuPro3, cpuPro4;
	private String str;
...
//This is a test
	...
	public String runCPU(){
		...
		cpuPro1 = Integer.parseInt(first.getPCPUtime());
		cpuPro1  = cpuPro1 - 1;
		first.setPCPUtime(Integer.toString(cpuPro1));

		actual = first.getNext();

		cpuPro2 = Integer.parseInt(actual.getPCPUtime());
		cpuPro2 =  cpuPro2 - 1;
		actual.setPCPUtime(Integer.toString(cpuPro2));

		actual = actual.getNext();

		cpuPro3 = Integer.parseInt(actual.getPCPUtime());
		cpuPro3 =  cpuPro3 - 1;
		actual.setPCPUtime(Integer.toString(cpuPro3));

		actual = actual.getNext();

		cpuPro4 = Integer.parseInt(actual.getPCPUtime());
		cpuPro4 =  cpuPro4 - 1;
		actual.setPCPUtime(Integer.toString(cpuPro4));
